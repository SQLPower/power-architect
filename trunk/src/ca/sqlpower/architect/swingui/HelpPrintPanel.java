 ...
 * </ul>
 */
public class HelpPrintPanel extends JPanel implements ArchitectPanel, Pageable, Printable, ChangeListener {
 ...
 //   protected PlayPen pp;
    ...
    public HelpPrintPanel(JEditorPane editorPane) {
        super();
        setOpaque(true);
    ...
    public void validateLayout() {
        ...
        Dimension ppSize = editorPane.getPreferredSize();
...
//            pp.print(g2);
    ...
    public class PrintPreviewPanel extends JPanel implements PropertyChangeListener {
        ...
        public PrintPreviewPanel() {
            ...
            HelpPrintPanel.this.addPropertyChangeListener(this);
        ...
        public void paintComponent(Graphics g) {
            ...
            g2.setColor(editorPane.getBackground());
            ...
            g2.scale(1/HelpPrintPanel.this.zoom, 1/HelpPrintPanel.this.zoom);
            g2.setColor(editorPane.getForeground());
            for (int i = 0; i <= pagesAcross; i++) {
                g2.drawLine((int) (i * iW), 0, (int) (i * iW), (int) (scaledHeight*HelpPrintPanel.this.zoom));
                if (logger.isDebugEnabled()) logger.debug("Drew page separator at x="+(i*iW));
            }

            for (int i = 0; i <= pagesDown; i++) {
                g2.drawLine(0, (int) (i * iH), (int) (scaledWidth*HelpPrintPanel.this.zoom), (int) (i * iH));
