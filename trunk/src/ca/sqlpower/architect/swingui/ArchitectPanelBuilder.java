...
public class ArchitectPanelBuilder {
	...
	/**
	 * Build a JDialog around an object that implements
	 * ArchitectPanel, to provide consistent behaviours
	 * such as Cancel button, <ESC> to close, and so on.
	 * @param arch The ArchitectPanel implementation
	 * @param dialogParent A Window class to be the parent, or null
	 * @param dialogTitle The display title.
	...
	public static JDialog createArchitectPanelDialog(
		...
		return createArchitectPanelDialog(arch,
				dialogParent,
				dialogTitle,
				actionButtonTitle,
				okAction,
