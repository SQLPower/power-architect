...
public class PostgresDDLGenerator extends GenericDDLGenerator {
	...
	protected void createTypeMap() throws SQLException {
		...
		typeMap.put(new Integer(Types.BIGINT), new GenericTypeDescriptor("NUMERIC", Types.BIGINT, 38, null, null, DatabaseMetaData.columnNullable, true, false));
		...
		typeMap.put(new Integer(Types.DECIMAL), new GenericTypeDescriptor("NUMERIC", Types.DECIMAL, 38, null, null, DatabaseMetaData.columnNullable, true, true));
